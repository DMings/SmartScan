...
//            "configs wrong"
//        }
        var eglConfig = chooseConfig(mEgl, mEglDisplay, configs)
        if (eglConfig == null) {
            eglConfig = configs[0]
        }
        ...
        if (eglContext == null) {
            this.eglContext =
                mEgl!!.eglCreateContext(mEglDisplay, eglConfig, EGL10.EGL_NO_CONTEXT, contextAttr)
        } else {
            this.eglContext =
                mEgl!!.eglCreateContext(mEglDisplay, eglConfig, eglContext, contextAttr)
        }
        ...
        mEglSurface = if (surface == null) {
            ...
            mEgl!!.eglCreateWindowSurface(mEglDisplay, eglConfig, surface, null)
        }
        //8. 绑定EglContext和Surface到显示设备中
        if (mEglDisplay != null && mEglSurface != null && this.eglContext != null) {
            if (!mEgl!!.eglMakeCurrent(mEglDisplay, mEglSurface, mEglSurface, this.eglContext)) {
